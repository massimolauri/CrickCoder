...
import {
    ...
    CheckCircle2, Circle, Timer, Trash2
} from 'lucide-react';
...
export default function TodoCard({ projectPath, sessionId }: TodoCardProps) {
    ...
    return (
        <div className="fixed top-20 right-4 z-50 w-80 md:w-96 max-h-[70vh] flex flex-col glass-panel rounded-2xl shadow-2xl animate-in zoom-in-95 slide-in-from-right-8 duration-300 border border-white/10 dark:border-white/5 overflow-hidden">
            {/* Header */}
